...
const Button = (props) => {
    ...
    const styleClass = {
        primary: {
            button: cx(
                'focus:shadow-[0_0_0_4px] hover:shadow-lg bg-primary-500 hover:bg-primary-400 ',
        ...
        disabled: {
            button: cx(
                'focus:shadow-[0_0_0_4px] hover:shadow-lg text-neutral-50 hover:text-neutral-50 bg-neutral-100 hover:bg-neutral-100',
