...
const ProductItem = (props) => {
    ...
    const CustomerFooter = (params) => {
        ...
        return (
            <div className="flex flex-col gap-2 tablet:gap-4 text-center">
                ...
                >
                    ...
                    <div className="pt-4 relative flex flex-col gap-4 flex-1">
                        ...
                        <Show when={showOption}>
                            <div className="hidden tablet:flex desktop:flex flex-col gap-2 tablet:gap-4 h-full justify-between items-center">
                                <ConfigurableOpt
                                    t={t}
                                    data={{
                                        ...other,
