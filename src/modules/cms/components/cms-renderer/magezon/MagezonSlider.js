            ...
            <div className="magezon-slider group flex flex-col relative">
                {owl_nav ? (
                    ...
                    >
                        ...
                        >
                            <ChevronLeft className="w-6 h-6 hover:text-neutral-white" />
                        </div>
                        <div
                            className={cx(
                                'magezon-slider--button-nav-item',
                        ...
                        >
                            <ChevronRight className="w-6 h-6 hover:text-neutral-white" />
                        </div>
                    </div>
                ) : null}
                ...
                <div
                    className={cx('magezon-slider--dot-nav', 'z-auto', 'hidden', 'justify-center', 'items-center', 'mt-[10px]', 'min-h-[20px]', {
